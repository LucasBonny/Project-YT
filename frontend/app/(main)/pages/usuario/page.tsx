...
const Usuario = () => {
    ...
    const saveUsuario = () => {
        ...
        if(!usuario.id) {
            if(usuario.login == '' || usuario.nome == '' || usuario.senha == '' || usuario.email == '') return toast.current?.show({
                severity: 'error',
                summary: 'Erro!',
            ...
            .catch((err) => 
                ...
                severity: 'error',
                summary: 'Erro!',
                detail: 'Login já foi registrado, use outro!'
                })
            )
        }
        else{
    ...
    const deleteSelectedUsuarios = () => {
         setDeleteUsuariosDialog(false);
         selectedUsuarios.forEach((x) => {
            if(x.id) usuarioService.excluir(x.id)
                .then((response) => {
                    toast.current?.show({
                        severity: 'success',
                        summary: 'Sucesso!',
